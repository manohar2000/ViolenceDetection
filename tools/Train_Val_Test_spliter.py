...
#=====================================================================================
LIST_OF_NO_FIGHT_DIR = ["/content/fight-detection-surv-dataset/noFight"]
LIST_OF_FIGHT_DIR = ["/content/fight-detection-surv-dataset/fight"]

VAL_SET_RATIO = 0.1
TEST_SET_RATIO = 0.4   # NUMBER_OF_TEST_SET = NUMBER_OF_TOTAL_DATA * TEST_SET_RATIO

PATH_TO_SAVE_SPLITED_DATASET = "/content/ViolenceDetection/data"
