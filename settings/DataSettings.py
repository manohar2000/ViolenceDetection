...
PATH_TO_TRAIN_SET_CATELOG = '/content/ViolenceDetection/data/train.txt'
PATH_TO_VAL_SET_CATELOG = '/content/ViolenceDetection/data/val.txt'
PATH_TO_TEST_SET_CATELOG = '/content/ViolenceDetection/data/test.txt'
